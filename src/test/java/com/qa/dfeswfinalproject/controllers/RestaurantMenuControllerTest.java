...
public class RestaurantMenuControllerTest {
	...
	public void createTest() throws Exception {
		RestaurantMenu entry = new RestaurantMenu("Olives", "Salad", "Risotto", "Tiramisu", 14.99f, "Italian");
		String entryAsJSON = mapper.writeValueAsString(entry);

		RestaurantMenu result = new RestaurantMenu(2L, "Olives", "Salad", "Risotto", "Tiramisu", 14.99f, "Italian");
	...
	public void readAllTest() throws Exception {
		...
		RestaurantMenu entry = new RestaurantMenu(1L, "Olives", "Salad", "Risotto", "Tiramisu", 14.99f, "Italian");
		output.add(entry);
	...
	public void updateTest() throws Exception {
		RestaurantMenu entry = new RestaurantMenu("Olives", "Salad", "Risotto", "Tiramisu", 14.99f, "Italian");
		String entryAsJSON = this.mapper.writeValueAsString(entry);
		RestaurantMenu result = new RestaurantMenu(1L, "Olives", "Salad", "Risotto", "Tiramisu", 14.99f, "Italian");
